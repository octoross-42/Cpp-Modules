...
void	test_sequenceContainers()
{
	...
	std::cout << std::endl << B << "vector" << std::endl << R << "⤷ " << has_find_prototype< std::vector<int> >() << std::endl;
	std::cout << v << std::endl;
	std::cout << " ⤷ 2: " << ((easyfind(v, 2) != v.end()) ? "in": "not in") << std::endl;
	std::cout << " ⤷ 5: " << ((easyfind(v, 5) != v.end()) ? "in": "not in") << std::endl;
	
	std::cout << std::endl << B << "deque" << std::endl << R << "⤷ " << has_find_prototype< std::vector<int> >() << std::endl;
	std::cout << d << std::endl;
	std::cout << " ⤷ 2: " << ((easyfind(d, 2) != d.end()) ? "in": "not in") << std::endl;
	std::cout << " ⤷ 5: " << ((easyfind(d, 5) != d.end()) ? "in": "not in") << std::endl;
	
	std::cout << std::endl << B << "list" << std::endl << R << "⤷ " << has_find_prototype< std::list<int> >() << std::endl;
	std::cout << l << std::endl;
...
void	test_associativeContainers()
{
	...
	std::cout << std::endl << B << "set" << std::endl << R << "⤷ " << has_find_prototype< std::set<int> >() << std::endl;
	std::cout << set << std::endl;
	std::cout << " ⤷ 2: " << ((easyfind(set, 2) != set.end()) ? "in": "not in") << std::endl;
	std::cout << " ⤷ 5: " << ((easyfind(set, 5) != set.end()) ? "in": "not in") << std::endl;
	
	
	std::cout << std::endl << B << "multiset" << std::endl << R << "⤷ " << has_find_prototype< std::multiset<int> >() << std::endl;
	...
	std::cout << std::endl << B << "map" << std::endl << R << "⤷ " << has_find_prototype< std::map<int, int> >() << std::endl;
	std::cout << map << std::endl;
	std::cout << " ⤷ 2: " << ((easyfind(map, 2) != map.end()) ? "in": "not in") << std::endl;
	std::cout << " ⤷ 5: " << ((easyfind(map, 5) != map.end()) ? "in": "not in") << std::endl;
	

	std::cout << std::endl << B << "multimap" << std::endl << R << "⤷ " << has_find_prototype< std::multimap<int, int> >() << std::endl;
...
void	test_adapativeContainers()
{
	...
	std::cout << "=========== Adaptative Containers ============" << std::endl;
	std::stack<int> stack;
    stack.push(1);
    stack.push(2);
    stack.push(3);
	...
	std::cout << std::endl << B << "stack" << std::endl << R << "⤷ " << has_find_prototype< std::stack<int> >() << std::endl;
	std::cout << stack << std::endl;
	std::cout << " ⤷ 2: " << ((easyfind(stack, 2) != NULL) ? "in": "not in") << std::endl;
	std::cout << " ⤷ 5: " << ((easyfind(stack, 5) != NULL) ? "in": "not in") << std::endl;
	
	std::cout << std::endl << B << "queue" << std::endl << R << "⤷ " << has_find_prototype< std::queue<int> >() << std::endl;
