...
/*   Updated: 2025/03/18 02:28:40 by octoross         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name)
{
	...
	_eneryPoints = 10;
	_attackDmg = 0;
	std::cout << "Welcome to ClapTrap: " << BOLD << YELLOW << name << RESET << "!" << std::endl;
}

ClapTrap::~ClapTrap(void)
{
	std::cout << "Bybye ClapTrap " << BOLD << YELLOW << _name << RESET << std::endl;
}
